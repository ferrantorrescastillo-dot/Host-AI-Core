...
export type CompraDraft = { id: string; proveedor: string; estado: string; lineas: CompraDraftLine[]; importe_estimado: number; observaciones?: string; creado_en: string; actualizado_en: string; recepciones?: Array<{ id: string; estado: string; lineas?: number }>; origen: { tipo: string; id: string; version: number; propuesta_id: string } };
