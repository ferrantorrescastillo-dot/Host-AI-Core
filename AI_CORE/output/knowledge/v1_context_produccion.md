...
- ROC/ROC-04A_COCINA.md (categoria=arquitectura, prioridad=110, estado=selected)
- ROC/ROC-04B_COCINA.md (categoria=arquitectura, prioridad=110, estado=selected)
