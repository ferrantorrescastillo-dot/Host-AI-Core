...
## Parámetros
- Dominio solicitado: general
- Fuentes seleccionadas: 12 de 517
...
- ROC/ROC-01A_NUCLEO.md (categoria=arquitectura, prioridad=60, estado=selected)
- ROC/ROC-01B_NUCLEO.md (categoria=arquitectura, prioridad=60, estado=selected)
- ROC/ROC-02A_OPERACION.md (categoria=arquitectura, prioridad=60, estado=selected)
- ROC/ROC-02B_OPERACION.md (categoria=arquitectura, prioridad=60, estado=selected)
- ROC/ROC-03A_NEGOCIO.md (categoria=arquitectura, prioridad=60, estado=selected)
- ROC/ROC-03B_NEGOCIO.md (categoria=arquitectura, prioridad=60, estado=selected)
- ROC/ROC-04A_COCINA.md (categoria=arquitectura, prioridad=60, estado=selected)
- ROC/ROC-04B_COCINA.md (categoria=arquitectura, prioridad=60, estado=selected)
...
5. ROC/ROC-01A_NUCLEO.md (categoria=arquitectura, prioridad=60)
6. ROC/ROC-01B_NUCLEO.md (categoria=arquitectura, prioridad=60)
7. ROC/ROC-02A_OPERACION.md (categoria=arquitectura, prioridad=60)
8. ROC/ROC-02B_OPERACION.md (categoria=arquitectura, prioridad=60)
...
### ROC/ROC-04A_COCINA.md
- Título detectado: ROC-04A — COCINA
- MotorEscandallos
...
### ROC/ROC-04B_COCINA.md
- Título detectado: ROC-04B — COCINA
- Importadores
- Motores auxiliares
