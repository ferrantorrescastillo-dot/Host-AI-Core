...
def build_default_tool_registry() -> HostAIToolRegistry:
    ...
    active_tools = [
        ...
        _tool("consultar_produccion", "Consultar produccion", "Consulta tareas de produccion por estado, fecha o termino", "CONSULTA", "READ", "PRODUCCION", "HostAIProduccionReadService", "consultar", tags=["produccion", "consulta", "solo_lectura"]),
