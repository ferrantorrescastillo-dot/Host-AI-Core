            ...
            normalizados.append(
                {
                    ...
                    "nombre": nombre,
                    "receta": nombre,
                    "receta_payload": dict(receta),
                    "rendimiento": receta.get("rendimiento", 0),
                    "unidad_rendimiento": receta.get("unidad_rendimiento", ""),
                    "estado_rendimiento": receta.get("estado_rendimiento"),
                    "origen_rendimiento": receta.get("origen_rendimiento"),
                    "rendimiento_neto": receta.get("rendimiento_neto"),
                    "ingredientes": [x for x in ingredientes if isinstance(x, dict)],
                    "elaboracion": receta.get("elaboracion") or receta.get("procedimiento"),
                    "pasos": receta.get("pasos"),
                    "observaciones": receta.get("observaciones"),
                    "tiempo_total": receta.get("tiempo_total") or receta.get("tiempo_elaboracion"),
                    "tiempo_activo": receta.get("tiempo_activo"),
                    "tiempo_pasivo": receta.get("tiempo_pasivo"),
                    "temperaturas": receta.get("temperaturas"),
                    "tecnicas_culinarias": receta.get("tecnicas_culinarias") or receta.get("tecnicas"),
                    "conservacion": receta.get("conservacion"),
                    "regeneracion": receta.get("regeneracion"),
                    "presentacion": receta.get("presentacion"),
                    "alergenos": receta.get("alergenos"),
                    "propuesta_procedimiento_ia": receta.get("propuesta_procedimiento_ia"),
                    "ingredientes_propuestos_ia": receta.get("ingredientes_propuestos_ia"),
                    "alergenos_posibles": receta.get("alergenos_posibles") or receta.get("posibles_alergenos") or receta.get("alergenos_inferidos"),
                    "conservacion_propuesta_ia": receta.get("conservacion_propuesta_ia") or receta.get("propuesta_conservacion_ia"),
                    "temperaturas_sugeridas_ia": receta.get("temperaturas_sugeridas_ia") or receta.get("temperaturas_propuestas"),
                    "tiempos_estimados_ia": receta.get("tiempos_estimados_ia") or receta.get("tiempos_propuestos"),
                    "observaciones_propuestas_ia": receta.get("observaciones_propuestas_ia") or receta.get("observaciones_sugeridas_ia"),
