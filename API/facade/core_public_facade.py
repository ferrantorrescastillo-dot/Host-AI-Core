...
class CorePublicFacade(Protocol):
    ...
    def ajuste_stock(self, body: dict[str, Any], context: Any, *, operation: str) -> dict[str, Any]: ...

    def eventos(self, query: dict[str, Any]) -> dict[str, Any]: ...
    def evento(self, evento_id: str) -> dict[str, Any]: ...
    def previsualizar_catalogo(self, body: dict[str, Any], context: Any) -> dict[str, Any]: ...
    def confirmar_catalogo(self, body: dict[str, Any], context: Any) -> dict[str, Any]: ...

    def reservas(self, query: dict[str, Any]) -> dict[str, Any]: ...

    def reserva(self, reserva_id: str) -> dict[str, Any]: ...
    def previsualizar_reserva(self, body: dict[str, Any], context: Any) -> dict[str, Any]: ...
    def confirmar_operacion_reserva(self, body: dict[str, Any], context: Any) -> dict[str, Any]: ...
    ...
    def previsualizar_rendimiento_elaboracion(
        self, elaboracion_id: str, body: dict[str, Any], context: Any,
    ) -> dict[str, Any]: ...
    ...
    def previsualizar_canonicalizacion_legacy_importacion(
        self, importacion_id: str, body: dict[str, Any], context: Any
    ) -> dict[str, Any]: ...
