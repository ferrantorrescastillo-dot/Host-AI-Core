...
def ejecutar_prueba():
    ...
    r5 = core.orquestador.resolver(SolicitudHostAI('controlar_ejecucion_produccion', {'planificacion': r3.datos, 'asignacion': r4.datos, 'avance': avance, 'minuto_actual': 260}))
    ...
    r7 = core.orquestador.resolver(SolicitudHostAI('optimizar_inteligente_produccion', {'planificacion': r3.datos, 'asignacion': r4.datos, 'control': r5.datos, 'replanificacion': r6.datos}))
    r8 = core.orquestador.resolver(SolicitudHostAI('comprobar_cierre_inteligente_produccion', {'elaboraciones': ELABORACIONES, 'analisis': r1.datos, 'alertas': r2.datos, 'planificacion': r3.datos, 'asignacion': r4.datos, 'control': r5.datos, 'replanificacion': r6.datos, 'optimizacion': r7.datos}))
    for r in (r1,r2,r3,r4,r5,r6,r7,r8): assert r.ok, r.mensaje
    ...
    assert r7.datos['version'] == '3.0.6.7'
    assert r8.datos['version'] == '3.0.6.8'
    print('TEST OK - Host AI 3.0.6.1 + 3.0.6.2 + 3.0.6.3 + 3.0.6.4 + 3.0.6.5 + 3.0.6.6 + 3.0.6.7 + 3.0.6.8 Producción')
    ...
    print('Optimizaciones:', r7.datos['total_oportunidades'])
    print('Cierre:', r8.datos['estado_cierre'])
