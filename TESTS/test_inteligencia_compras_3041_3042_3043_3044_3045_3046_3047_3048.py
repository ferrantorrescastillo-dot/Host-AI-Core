...
def ejecutar_prueba():
    ...
    pedidos = core.orquestador.resolver(SolicitudHostAI("generar_pedidos_inteligentes", {"horizonte_dias":14})); assert pedidos.ok
    cierre = core.orquestador.resolver(SolicitudHostAI("comprobar_cierre_inteligencia_compras", {})); assert cierre.ok
    print("TEST OK - Host AI 3.0.4.1 + 3.0.4.2 + 3.0.4.3 + 3.0.4.4 + 3.0.4.5 + 3.0.4.6 + 3.0.4.7 + 3.0.4.8 Inteligencia de Compras")
    ...
    print("Decisiones pedidos:", pedidos.datos["total_decisiones"])
    print("Cierre:", cierre.datos["modulos_validados"], "/", cierre.datos["total_modulos"])
