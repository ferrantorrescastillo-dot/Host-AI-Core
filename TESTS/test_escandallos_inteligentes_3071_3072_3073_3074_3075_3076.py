...
def ejecutar_prueba():
    ...
    c=core.orquestador.resolver(SolicitudHostAI('comparar_historico_escandallos',{'escandallos_actuales':ESCANDALLOS,'escandallos_anteriores':ESCANDALLOS})); assert c.ok, c.mensaje
    ...
    print('TEST OK - Host AI 3.0.7.1 + 3.0.7.2 + 3.0.7.3 + 3.0.7.4 + 3.0.7.5 + 3.0.7.6 Escandallos Inteligentes')
